 ...
 */
Measurement.caretPos = function(textarea, mode) {
    /**
     * @type {Element}
     */
    var targetElement;
    if ((typeof jQuery != 'undefined') && (textarea instanceof jQuery)) {
	targetElement = /** @type {Element} */textarea.get(0);
    } else {
        targetElement = /** @type {Element} */textarea;
    }
    // HTML Sanitizer
	...
	return {left: parseInt(left, 10), top: parseInt(top, 10),
		right: parseInt(right, 10), bottom:parseInt(bottom, 10)};
    };
	...
	if (/** @type {*} */(targetElement).wrap == "off") {
